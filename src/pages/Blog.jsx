...
const Blog = () => {
            ...
            const {comments_count,title,reading_time_minutes,published_at, public_reactions_count,tags}=blog
            return (
                        <div className="max-w-2xl px-6 py-16 mx-auto space-y-12">
                        <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
         <div className="space-y-6">                 <h1 className="text-4xl font-bold md:tracking-tight md:text-5xl">{title}</h1>
